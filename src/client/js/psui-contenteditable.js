...
.directive('psuiContenteditable', ['$timeout', function ($timeout) {
	return {
		...
		link: function(scope, elm, attrs, ctrls) {
			...
			var buttonCenter = angular.element('<button type="button">Center</button>');
			var buttonLeft = angular.element('<button type="button">Left</button>');
			var buttonRight = angular.element('<button type="button">Right</button>');
			var buttonJustify = angular.element('<button type="button">Justify</button>');
			var buttonBold = angular.element('<button type="button"><b>Bold</b></button>');
			var buttonItalic = angular.element('<button type="button"><i>Italic</i></button>');
			var buttonRemoveFormat = angular.element('<button type="button">Remove format</button>');
			var buttonRemoveHeading = angular.element('<button type="button">Remove heading</button>');
			var buttonLink = angular.element('<button type="button">Link</button>');
			var buttonImage = angular.element('<button type="button">Image</button>');
			var buttonUndo = angular.element('<button type="button">Undo</button>');
			var buttonRedo = angular.element('<button type="button">Redo</button>');
			var buttonH1 = angular.element('<button type="button">H1</button>');
			var buttonH2 = angular.element('<button type="button">H2</button>');
			var buttonH3 = angular.element('<button type="button">H3</button>');
			var buttonOL = angular.element('<button type="button">OL</button>');
			var buttonUL = angular.element('<button type="button">UL</button>');
			var buttonOutdent = angular.element('<button type="button">Outdent</button>');
			var buttonIndent = angular.element('<button type="button">Indent</button>');
			var buttonTable = angular.element('<button type="button">Table</button>');
