...
.config(['$translateProvider', function($translateProvider) {
	...
	$translateProvider.translations('sk', {
		...
		"security.profile.edit.entity":"Bezpečnostný profil",
		...
		"security.user.edit.entity": "Osoba",
	...
	$translateProvider.translations('cz', {
		...
		"security.profile.edit.searching":"Bezpečnostní profil vyhledávání",
		"security.profile.edit.entity":"Bezpečnostní profil",
	...
	$translateProvider.translations('eng', {
		...
		"menu.massmailing.title":"Massmail",
		...
		"massmailing.sent":"Message has been sent.",

		"massmail.predefined.template": "Predefined template",
		"massmail.plaintext.template":"Plaintext",
		"massmail.subject.template":"Subject ",
		"massmail.html.template":"HTML template",
		"massmail.search.recipient":"Search recipient",
		"massmail.send.view":"Massmail",
		"massmail.selection.all":"By filter",

		"header.settings": "Settings",
		"header.log.out": "Log out",
		"personal.change.password.change.password": "Change password",
		"personal.change.password.current.password": "Current password",
		"personal.change.password.new.password": "New password",
		"personal.change.password.new.password.check": "Confirm new password",
		"generic.search.searching": "Searching",
		"generic.search.add": "Add",
		"generic.search.remove": "Remove",
		"generic.search.search": "Search",
		"generic.search.atribute": "Atribute",
		...
		"registry.succesfully.generated":"Succesfully generated",
		...
		"security.group.edit.modification.of.security.group": "Modifikácia bezpečnostnej skupiny",
		"security.user.edit.modification.done": "User has been modified",
		"security.user.missing.permissions":"Missing permissions: {{data}}",
		"security.user.session.expired":"Pre nečinnosť ste boli odhlásený.",

		"security.profile.edit.searching":"Search security profil",
		"security.profile.edit.entity":"Security profil",
		...
		"security.profile.edit.available.permissions":"Available premissions",
		"security.profile.edit.save":"Save",
		"security.profile.edit.cancel":"Remove",
		"security.profile.edit.edit":"Edit",
		"security.profile.edit.data.criteria":"Filtrácia dát",
		"security.user.edit.entity": "Person",
		"security.user.edit.profile":"User profiles",
		"security.user.edit.added.profiles":"Added profiles",
		"security.user.edit.available.profiles":"Available profiles",
		"security.profile.edit.modification.done":"Succesfully saved",
		...
		"schema.editor.list.of.schemas.for.editation": "List of schemes for editing",
		"personal.change.password.passwords.not.equal": "New and confirm password not equal!",
		"personal.change.password.password.changed": "Password changed",
		"personal.change.password.password.not.changed": "Heslo sa nepodarilo zmeniť: {{data}}",
		"registry.succesfully.saved":"Succesfully saved",
		"registry.unsuccesfully.saved":"Nepodarilo sa uložiť dáta!",
		"registry.form.not.filled.correctly":"Form is not filled correctly",
		"psui.uploadable.image.unsupported.image.type":"Unsupported image format",
		"psui.imageresizor.rotate":"rotate",
		"psui.imageresizor.ok":"ok",
		"psui.uploadable.file.unsupported.file.type":"Unsupported image format",
		"date.monday":"Mon",
		"date.tuesday":"Tue",
		"date.wednesday":"Wed",
		"date.thursday":"Thu",
		...
		"security.user.edit.searching":"Searching",
		...
		"security.user.edit.permissions.for.user":"Permissions for user",
		"security.user.edit.available.groups":"Available groups",
		"security.user.edit.added.groups":"Added groups",
		"security.user.edit.groups.for.users":"Groups for users",
		...
		"security.user.edit.cancel":"Remove",
		...
		"errors.validation.psuiUnique": "Hodnota už v systéme existuje",
		"schema.editor.schema.editing":"Scheme editing",
		"security.group.edit.parent.group":"Parent group",
		"schemas.group.base.data":"Basic information",
		"schemas.group.base.data.ID":"Identifier",
		...
		"schema.statistics.member.count":"Membership",
		"schema.statistics.women.count":"Women count",
		"schema.statistics.fees":"Fees",
		"schema.statistics.fees.expected.count":"Expected count",
		"schema.statistics.fees.expected.sum":"Expected sum",
		"schema.statistics.fees.paid.count":"Paid count",
		"schema.statistics.fees.paid.sum":"Paid sum",
		"schema.statistics.fees.overdue.count":"Overdue count",
		"schema.statistics.fees.overdue.sum":"Overdue sum",
